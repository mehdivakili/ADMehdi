...
trait ADMehdiUser
{
    ...
    {
        return $this->belongsTo(ADMehdi::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(ADMehdi::modelClass('Role'), 'user_roles', 'user_id', 'role_id');
    }
    ...
    {
        $role = ADMehdi::model('Role')->where('name', '=', $name)->first();
