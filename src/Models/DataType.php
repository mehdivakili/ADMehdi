...
use ADMehdi\Database\Schema\SchemaManager;
...
class DataType extends Model
{
    ...
    {
        return $this->hasMany(ADMehdi::modelClass('DataRow'))->orderBy('order');
    }
    ...
    {
        return $this->hasMany(ADMehdi::modelClass('DataRow'))->orderBy('order', 'DESC')->first();
    }
        ...
        try {
            ...
            if ($this->fill($requestData)->save()) {
                ...
                foreach ($fields as $field) {
                    ...
                    if (!$dataRow->save()) {
                        throw new \Exception(__('admehdi::database.field_safe_failed', ['field' => $field]));
                    }
                ...
                if ($this->generate_permissions) {
                    ADMehdi::model('Permission')->generateFor($this->name);
                }
