...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify admehdi user configs
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify admehdi controller settings
    |
    */

    'controllers' => [
        'namespace' => 'ADMehdi\\Http\\Controllers',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify admehdi database settings
    |
    */

    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'password_resets', 'permission_role', 'personal_access_tokens', 'settings'],
        ],
    ...
    */
    ...
    'dashboard' => [
        ...
        'navbar_items' => [
            'admehdi::generic.profile' => [
                'route'      => 'admehdi.profile',
                'classes'    => 'class-full-of-rum',
                'icon_class' => 'admehdi-person',
            ],
            'admehdi::generic.home' => [
                'route'        => '/',
                'icon_class'   => 'admehdi-home',
                'target_blank' => true,
            ],
            'admehdi::generic.logout' => [
                'route'      => 'admehdi.logout',
                'icon_class' => 'admehdi-power',
            ],
        ],
